...
SWFUpload.prototype.debugMessage = function (message) {
	if (this.settings.debug) {
		...
		// Check for an handler object and print it nicely
...
var swfuploadefaults={
	...
	upload_url: "job/plugin/swfupload/upload.php",
	button_image_url: "job/plugin/swfupload/XPButtonUploadText_61x22.png",
	button_width: 61,
	button_height: 22,
	flash_url: "job/plugin/swfupload/swfupload.swf",
